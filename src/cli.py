...
def scrape(roadmap: Optional[str], output: Optional[str], interactive: bool, list_roadmaps: bool, verbose: bool) -> None:
    ...
    try:
            ...
            while True:
                ...
                if selection.isdigit():
                    ...
                    if 0 <= idx < len(roadmaps):
                        ...
                        click.secho(f"Invalid number. Please enter 1-{len(roadmaps)}", fg='yellow')
                        continue
                ...
                if selection in roadmaps:
                    ...
                    click.secho(f"Roadmap '{selection}' not found. Please try again.", fg='yellow')
                    continue
        ...
        if not roadmap:
            click.secho("Error: Please specify a roadmap using --roadmap or --interactive", fg='red')
            click.echo("Use --list to see available roadmaps")
            sys.exit(1)
        
        scraper = JSONRoadmapScraper(
